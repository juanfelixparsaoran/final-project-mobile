...
Mobile.setText(findTestObject('Object Repository/Deposit/android.widget.EditText - Enter Deposit Amount ()'), '0', 0)

Mobile.tap(findTestObject('Object Repository/Deposit/android.widget.Button - DEPOSIT'), 0)

Mobile.verifyElementExist(findTestObject('Deposit/android.widget.TextView - Account balance 100000.00 (1)'), 0)
