...
Mobile.setText(findTestObject('Payment/android.widget.EditText - Payee Name'), 'Breakfast', 0)

Mobile.tap(findTestObject('Object Repository/Payment/android.widget.Button - ADD'), 0)

Mobile.setText(findTestObject('Object Repository/Payment/android.widget.EditText - Amount'), '10', 0)

Mobile.tap(findTestObject('Object Repository/Payment/android.widget.Button - Make Payment'), 0)

Mobile.getText(findTestObject('Object Repository/Payment/android.widget.TextView - Tabungan 1 (99900.00)'), 0)
